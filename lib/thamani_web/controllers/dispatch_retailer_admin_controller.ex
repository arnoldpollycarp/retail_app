defmodule ThamaniWeb.DispatchRetailerAdminController do
  ...
  def index(conn, _params) do
    ...
    dispatch = Dispatches_Retailer.list_dispatches_retailer()
  ...
  def show(conn, %{"id" => id}) do
    ...
    dispatch = Dispatches_Retailer.get_dispatch_retailer!(id)
