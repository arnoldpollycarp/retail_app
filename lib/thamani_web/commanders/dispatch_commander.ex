defmodule ThamaniWeb.DispatchCommander do
  use Drab.Commander
  ...
  defhandler fetch_data(socket, sender) do
    ...
    sender_name = Dispatches.get_warehouse_name(warehouse)
    sender_phone = Dispatches.get_warehouse_phone(warehouse)
    sender_email = Dispatches.get_warehouse_email(warehouse)
