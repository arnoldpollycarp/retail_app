defmodule ThamaniWeb.RetmanOrdersCommander do
  use Drab.Commander
  alias Thamani.Items
  ...
  defhandler return_uom(socket, sender) do
    ...
    company = Manufacturer_orders.get_manufacturer(item)
  ...
  defhandler add_order(socket, sender) do
    ...
    if String.to_integer(quantity) < String.to_integer(min) do
